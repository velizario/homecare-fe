import { Box, Image, Button, Flex, Grid, Textarea, FormControl, FormErrorMessage } from "@chakra-ui/react"
                        ...
                        <Flex flexDirection="column" alignItems="flex-start" justifyContent="flex-start" width="full" pointerEvents={profileEditable ? "unset" : "none"} >
                            <label htmlFor="fileupload">
                                <Box cursor="pointer" border="1px solid gray.200">
                                    ...
                                    <Button mb="5px" verticalAlign="text-top" size="sm" variant="link" disabled={!profileEditable} cursor={profileEditable ? "pointer" : "unset !important"} visibility={profileEditable ? "visible" : "hidden"}>Качете снимка</Button>
