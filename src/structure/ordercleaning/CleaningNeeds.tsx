...
const CleaningNeeds :React.FC = () => {
    ...
    return (
        ...
        <Container py='12' bg='white' display='flex' alignItems='center' flexDirection='column' borderRadius='2xl' boxShadow='rgb(0 5 82 / 8%) 0px 7px 14px 0px'>
            ...
            <OrderItem data-id='1' selectable={true} active={schedule===1} onClick={chooseSchedule} >
               <Text fontSize='lg' fontWeight={schedule === 1 ? 'bolder' : 'normal'}>Every week</Text>                 
               <Text fontSize='lg' fontWeight='bolder'>469 kr/h</Text>
            </OrderItem>
            <OrderItem data-id='2' selectable={true} active={schedule==2} onClick={chooseSchedule} >
               <Text fontSize='lg' fontWeight={schedule === 2 ? 'bolder' : 'normal'}>Every second week</Text>                 
               <Text fontSize='lg' fontWeight='bolder'>469 kr/h</Text>
            </OrderItem>
            <OrderItem data-id='3' selectable={true} active={schedule===3} onClick={chooseSchedule} >
            ...
            <Box mt='10' w='full' display='flex' flexDir='column' alignItems='center'>
                ...
                <OrderItem data-id='fridge' selectable={true} active={services.fridge === 1} onClick={chooseServices} >
                    <Box>
                ...
                <OrderItem data-id='oven' selectable={true} active={services.oven === 1} onClick={chooseServices} >
                    <Box>
                ...
                <OrderItem data-id='ironing' selectable={true} active={services.ironing === 1} onClick={chooseServices} >
                    <Box>
